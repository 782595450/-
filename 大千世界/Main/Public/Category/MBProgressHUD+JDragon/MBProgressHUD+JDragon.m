...
#define LS_NORMAL_DELAY_TIME                1.5
...
{
    [self showTipMessage:message isWindow:true timer:LS_NORMAL_DELAY_TIME];
}
+ (void)showTipMessageInView:(NSString*)message
{
    [self showTipMessage:message isWindow:false timer:LS_NORMAL_DELAY_TIME];
}
